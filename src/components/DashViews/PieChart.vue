<template>
  <div class="small" >
    <pie-chart :data="chartData" :options="chartOptions" width="100%" height="100px" ></pie-chart>
...
export default {
  ...
  created(){
    axios.post('https://aaomach.pythonanywhere.com/piechart',{'district_n0':localStorage.getItem('district')},
    {
       headers:{
