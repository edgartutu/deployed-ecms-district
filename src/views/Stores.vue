...
import axios from 'axios'
  export default {
    ...
    created(){
      axios.post('https://aaomach.pythonanywhere.com/AllDeclinedComplaints',{"district_n0":localStorage.getItem('district')}).then(
        response =>{
    ...
    methods:{
        retrieve(index){
            this.complaints_refn0 = this.items[index].complaints_refn0
             axios.post('https://aaomach.pythonanywhere.com/updatedeclinedcomplaint',{'admin_email':this.email,
