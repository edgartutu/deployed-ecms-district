       ...
       <v-card max-height="400px" style="overflow-y: auto" class="pa-3" outline max-width="1300"  height="400px">
           <v-flex sm12 md6>
              ...
              <v-card-actions>
                ...
                <router-link to="/login">
                     <v-btn color="primary" :disabled='isDisabled'  @click="submit(),login()">Register</v-btn>
                </router-link>
...
'Sheema',
    ...
    methods:{
        submit(){
        //console.log('hello')
        axios.post('https://aaomach.pythonanywhere.com/register',{
      ...
      retrieve(index){
             ...
             axios.post('https://aaomach.pythonanywhere.com/AccountDistrict',{"district_n0":this.district_no}).then(
        response =>{
          window.location.reload()
